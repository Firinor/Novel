    ...
    public class P1Scene1 : DialogNode
    {
        public override async void StartDialog()
        {
            ...
            await ShowImage(Backgrounds.KarimRoom, new string[2]{
                "сейчас € должен открыть портал дл€ прохода" + Environment.NewLine + "торгового каравана в столицу. ќставл€ю вас." +
                    " ƒит€ мое, помни" + Environment.NewLine + ", что € горжусь тобой и" + Environment.NewLine + " все уже готово дл€ праздновани€.", ""});
